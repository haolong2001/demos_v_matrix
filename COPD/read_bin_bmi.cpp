...
int main() {
    ...
    const std::string input_file = "./output/20250620_101235_2940/BMI/bmi_matrix_0.bin";
    const std::string output_file = "./output/20250620_101235_2940/BMI/bmi_matrix_0.csv";
    const int cols = 27;
