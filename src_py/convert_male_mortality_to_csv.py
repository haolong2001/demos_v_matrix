#!/usr/bin/env python3
"""
Convert Male_mortality.csv to the requested format.
...
def convert_male_mortality_to_csv(input_file, output_file):
    """
    Convert Male_mortality.csv to the requested format with continuous ages 0-85.
    
    Args:
        input_file: Path to Male_mortality.csv
    ...
    age_data = df[df['Data Series'] != 'Male Age Specific Death Rate'].copy()
...
def main():
    """Main function to convert the male mortality data."""
    
    # File paths
    input_file = "../data/Male_mortality.csv"
    output_file = "male_mortality_converted.csv"
    
    print("Converting Male_mortality.csv to requested format with continuous ages 0-85...")
    ...
    try:
        ...
        # Convert the data
        output_df = convert_male_mortality_to_csv(input_file, output_file)
